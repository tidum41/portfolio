...
const FB = {
  tocItems: [
    ...
    { _key: "t2", id: "research",   label: "Insight"            },
    { _key: "t3", id: "process",    label: "Wedge"              },
    { _key: "t4", id: "decision-1", label: "Complete listings"  },
    { _key: "t5", id: "decision-2", label: "Borrowed trust"     },
    { _key: "t6", id: "decision-3", label: "Time is quarters"   },
    { _key: "t7", id: "decision-4", label: "Tax the lister"     },
    { _key: "t8", id: "solution",   label: "The product"        },
    { _key: "t9", id: "reflection", label: "Judgment"           },
  ] as TocItem[],
  heroTagline:   "Product Design  ·  Case Study  ·  2026",
  heroTitle:     "Students search in quarters. Listings are written in paragraphs.",
  heroBg:        "#C6DDF2",
  ...
  problemHeading: "Seekers spray the same five questions across three apps. Listers sit on empty inboxes and assume there is no demand.",
  problemBody: "UCLA subletting is a two-sided matching problem that still runs on Facebook paragraphs, Reddit threads, and ULoop listings that don't know what a quarter is. I learned that the hard way: two weeks of threads and friends-of-friends to find a summer room. I got lucky. The job is not \"subleasing is stressful.\" It is find (or fill) a 10-week room that starts when spring quarter ends, from a real student, without DMing twelve people for rent, dates, and whether the bathroom is shared.",
  ...
  researchHeading: "Seekers cannot tell if a post is complete or a person is real. Listers have no idea why nobody is responding.",
  ...
  d1Heading: "If the card is incomplete, BruinLease is Facebook with extra steps.",
  ...
  d2Heading: "Native reviews will not exist in week one. Borrow the building's reputation instead.",
  ...
  d3Heading: "Demand is not June 15–September 8. It is summer after spring finals.",
  ...
  d4Heading: "Completeness for seekers is a tax on supply. The create flow is the integrity system.",
