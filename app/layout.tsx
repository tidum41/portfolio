    ...
    >
      <head>
        ...
        {/* CSS cursor tip — compositor-drawn so it still tracks during JS
            hitches. Press is :active (also compositor). JS draws trail + pills. */}
        <style dangerouslySetInnerHTML={{ __html: `@media(pointer:fine) and (prefers-reduced-motion:no-preference){html,html *{cursor:url("/cursors/dot-light.svg") 10 10,auto!important}html:active,html *:active{cursor:url("/cursors/dot-light-press.svg") 10 10,auto!important}html[data-theme="dark"],html[data-theme="dark"] *{cursor:url("/cursors/dot-dark.svg") 10 10,auto!important}html[data-theme="dark"]:active,html[data-theme="dark"] *:active{cursor:url("/cursors/dot-dark-press.svg") 10 10,auto!important}}` }} />
